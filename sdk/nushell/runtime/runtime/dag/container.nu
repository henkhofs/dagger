...
export def "container directory" [
    ...
    let result = dagger-query $query
    {id: $result.loadContainerFromID.directory.id} | with-type "Directory"
}
...
export def "container file" [
    ...
    let result = dagger-query $query
    {id: $result.loadContainerFromID.file.id} | with-type "File"
}
...
export def "container as-tarball" []: record -> record {
    ...
    let result = dagger-query $query
    {id: $result.loadContainerFromID.asTarball.id} | with-type "File"
}
...
export def "container as-service" []: record -> record {
    ...
    let result = dagger-query $query
    {id: $result.loadContainerFromID.asService.id} | with-type "Service"
}
